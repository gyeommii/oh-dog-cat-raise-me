...
<main id="login-form-wrapper m-3" style="width: 50%; margin: auto; padding-top: 3%;"> d
    <div id="searchDiv" class="mb-3 card p-3" style="width: 70%; margin:auto">
        <h2 class="my-4" style="margin: auto">아이디 찾기</h2>
        <form class="mb-3 card-body" method="post" action="./result/password">
            <div class="">
                <div class="mb-3 my-3">
                    <label for="input-pw" class="form-label py-2">새로운 비밀번호</label>
                    <input type="password" class="form-control my-1" name="password" id="input-pw"
                           required>
                </div>
                <div class="mb-3 my-3">
                    <label for="input-pw-check" class="form-label py-2">비밀번호 확인</label>
                    <input type="password" class="form-control my-1" name="password-check"
                           id="input-pw-check"
                           required>
                </div>
