...
<body>
    ...
    <main id="login-form-wrapper m-3"
        style="width: 50%; margin: auto; padding-top: 3%;">
        <div class="mb-3 card p-3" style="width: 70%; margin: auto">
            ...
            <form class="mb-3 card-body" method="post">
                <div class="mb-3">
                    <label for="inputUserId" class="form-label p-2"><img
                        class="login-icon m-2" src="../images/user.png" />아이디<span
                        class="text-danger">*</span></label> <input type="text"
                        class="form-control mx-2" id="inputUserId"
                        name="member_id" required>
                </div>
                <div class="mb-3">
                    <label for="inputPw" class="form-label mx-2"><img
                        class="login-icon m-2"
                        src="../images/locker.png" />비밀번호<span
                        class="text-danger">*</span></label> <input
                        type="password" class="form-control mx-2"
                        id="inputPw" name="password" required>
                </div>
                <div id="login-result-desc">
                    아이디(로그인 전용 아이디) 또는 비밀번호를 잘못 입력했습니다.<br /> 입력하신 내용을
                    다시 확인해주세요.
                </div>
