    ...
    <div class="mb-3 card p-3" style="width: 70%; margin:auto">
        <form class="mb-3 card-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control mx-2" id="inputUserId" required>
            </div>
            <div class="mb-3">
        ...
        <div id="login-result-desc" class="text-danger d-none">아이디(로그인 전용 아이디) 또는 비밀번호를 잘못 입력했습니다.<br/>
            입력하신 내용을 다시 확인해주세요.</div>
        <button id="loginBtn" class="btn btn-outline-success">로그인</button>
    </div>
</main>
